                                        ...
                                        <table class="table table-borderless mb-0">
                                            <thead>
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <form id="addServiceForm"
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="serviceName">اسم المنتج</label>
                                                                            <input type="text" class="form-control"
                                                                                id="serviceName" name="name" required
                                                                                placeholder="ادخل اسم المنتج">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="serviceName">وصف المنتج</label>
                                                                            <input type="text" class="form-control"
                                                                                id="serviceName" name="description"
                                                                                required placeholder="ادخل وصف المنتج">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="serviceName">سعر المنتج</label>
                                                                            <input type="number" class="form-control"
                                                                                id="serviceName" name="price" required
                                                                                placeholder="ادخل سعر المنتج">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="serviceName">المنتج تابع لاي
                                                                                خدمة</label>
                                                                            <select class="form-control"
                                                                                id="serviceName" name="service_id"
                                                                                required>
                                                                                <option value="">اختر الخدمة
                                                                                </option>
                                                ...
                                                <tr>
                                                    ...
                                                    <th scope="col">المنتج تابع لخدمة</th>
                                                    <th scope="col">المنتج تابع لتاجر</th>
                                                    <th scope="col">العمليات</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @foreach (Auth()->user()->role == 'admin' ? $Allproducts : $products as $product)
                                                    <tr>
                                                        <td>{{ $product->name }}</td>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('deleteProducts', $product->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                <button type="submit"
